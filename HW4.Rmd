...
mycodes <- codelist
mycodes1 <- mycodes %>% select(continent, wb, country.name.en) %>% filter(continent == "Europe") %>% drop_na(wb) # select countries based on continent, wb, and country name in English

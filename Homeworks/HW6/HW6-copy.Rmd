...
sd_diffs = sd(means_difference)
mean_diff = mean(means_difference)
error <- qt(0.975,df=30)*sd_diffs/sqrt(32)
left <- mean_diff-error
right <- mean_diff + error
left
right

```
```{r}
t.test(weight ~ sex, data=mosquitoes, conf.level=.95)
```

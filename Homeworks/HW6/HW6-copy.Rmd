...
femaleInsectWeights <- c(0.291, 0.208, 0.241, 0.437, 0.228, 0.256, 0.208, 0.234, 0.320, 0.340, 0.150)
maleInsectWeights <- c(0.185, 0.222, 0.149, 0.187, 0.191, 0.219, 0.132, 0.144, 0.140)
...
*From looking at the results of the Shapiro-Wilk test results from the previous section, the transformed data is approximately normally distributed. With regards to the QQplot, the points on the transformed variable are very close to the reference lines for the normal distribution and the t distribution with the corresponding degrees of freedom, so all assumptions are met.*
...
```{r}
t.test(logFemaleInsectWeights, logMaleInsectWeights, var.equal = FALSE)
```
